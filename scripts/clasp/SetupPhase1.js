...
function runSetupPhase1() {
  ...
  // Sheet: Users
  const sheetUsers = registrySS.insertSheet('Users');
  sheetUsers.appendRow([
    'User_ID', 'Username', 'PIN', 'Nama', 'Role', 'Cabang_ID', 'Aktif', 'Tanggal_Dibuat'
  ]);
  formatHeader_(sheetUsers);
  // Default admin user
  sheetUsers.appendRow(['USR00001', 'admin', '123456', 'Administrator', 'admin', '', true, new Date()]);
